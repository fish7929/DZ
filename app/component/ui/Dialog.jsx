...
class Dialog extends React.Component {
     ...
     */
    renderScreenDialog() {
        var _buttonDom = this.state.isHideBtn ? (<div className='screen-dialog-button btn-active' onTouchTap={(e) => this.sureHandler(e)}>确定</div>) :
    ...
    render() {
        ...
        return this.state.isShow ? (
            <div className={_className}>
                {this.state.type === FIRST ? this.renderScreenDialog() : this.renderToastDialog()}
            </div>
        ) : null;
    }
    /**
